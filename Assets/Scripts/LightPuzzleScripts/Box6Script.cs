...
public class Box6Script : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (GetComponent<Collider2D>().IsTouching(GameObject.FindWithTag("Player").GetComponent<Collider2D>()))
        {
            ...
            {
                Debug.Log("Box 6 pressed");
                // Flip all the switches
                affectedBoxes[0].GetComponent<Box3Script>().activated = !affectedBoxes[0].GetComponent<Box3Script>().activated;
                affectedBoxes[1].GetComponent<Box5Script>().activated = !affectedBoxes[1].GetComponent<Box5Script>().activated;
                affectedBoxes[2].GetComponent<Box6Script>().activated = !affectedBoxes[2].GetComponent<Box6Script>().activated;
                affectedBoxes[3].GetComponent<Box9Script>().activated = !affectedBoxes[3].GetComponent<Box9Script>().activated;
            }
        }
